    ...
    */
    for (int i = 0; i < studentScores.Length; i++)
    {
        if (i >= examAssignments)
            ...
            sumAssignmentScores += studentScores[i];
    }
    ...
    // The average of the extra credit scores
    int extraCreditScore = sumExtraCreditScores / extraAssignments;
    decimal extraCreditPoints = sumExtraCreditScores * 0.1m / examAssignments;

    // Overall grade
    decimal currentStudentGrade = (decimal)sumAssignmentScores / examAssignments + extraCreditPoints;
